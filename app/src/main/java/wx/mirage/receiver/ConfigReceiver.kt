...
class ConfigReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        private var receiverInstance: ConfigReceiver? = null
        ...
        fun register(context: Context) {
            ...
            context.registerReceiver(receiver, filter, Constants.PERMISSION_CONTROL, null)
        ...
        fun cleanup() {
            try {
                if (registered) {
                    receiverInstance?.let { contextRef?.unregisterReceiver(it) }
